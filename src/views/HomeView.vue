...
<template>
  <section class="bg-white dark:bg-gray-900">
    <div class="py-8 px-4 mx-auto max-w-screen-xl text-center lg:py-16">
      ...
      >
        I am a software engineer with a passion for using technology to create
    ...
    <div class="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
      ...
      <a
        ...
        <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-6">
          I've worked in full-stack development, ranging from Java Spring Applications with Vue to using Python Django and React. I've been involved with the whole software development process, from testing with JUnit, Mockito, Selenium and PyUnit to setting up and deploying applications with CI/CD workflows on GitHub and Bitbucket to deploy on AWS. 
        </p>
        <a
          href="#"
      ...
      <div class="grid md:grid-cols-2 gap-8">
        ...
        >
          ...
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
            I love working in teams to develop great products. By communicating with stakeholders and end-users, I aim to deliver software that empowers users.  
          </p>
          <a
            href="#"
        ...
        >
          ...
          <p class="text-lg font-normal text-gray-500 dark:text-gray-400 mb-4">
            I would love to connect! Please check out my GitHub to see some of the projects I've done and connect on LinkedIn. 
          </p>
          <a
            href="#"
            class="text-blue-600 dark:text-blue-500 hover:underline font-medium text-lg inline-flex items-center"
